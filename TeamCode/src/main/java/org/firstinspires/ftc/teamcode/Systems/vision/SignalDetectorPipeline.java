...
public class SignalDetectorPipeline extends OpenCvPipeline
{
    ...
    // Tag Dimensions in Meters
    double tagSize = 0.03;
    double tagSizeX = 0.03;
    double tagSizeY = 0.03;

    private final float decimation = 1;
    private final int threads = 50;
    private boolean needToSetDecimation;
    private final Object decimationSync = new Object();

    public SignalDetectorPipeline(Telemetry t)
    {
        telemetry = t;
        ...
        nativeApriltagPtr = AprilTagDetectorJNI.createApriltagDetector(AprilTagDetectorJNI.TagFamily.TAG_36h11.string, decimation, threads);
